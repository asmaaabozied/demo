...
<section class="material-half-bg">
    <div class="cover" style="background-color:#F4C400;"></div>
</section>
    ...
    <div class="login-box flipped">
        <form class="forget-form" action="{{ route('password.email') }}" method="post">
            ...
            <div class="form-group btn-container">
                <button class="btn btn-primary btn-block" style="background-color:#F4C400; border-color:#F4C400;" type="submit">
                    <i class="fa fa-unlock fa-lg fa-fw mr-2"></i>
                    @lang('dashboard.auth.forget.submit')
                </button>
            </div>
            <div class="form-group mt-3">
                <p class="semibold-text mb-0"><a href="#" style="color:#F4C400;" data-toggle="flip">

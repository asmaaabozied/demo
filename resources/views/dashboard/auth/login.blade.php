    ...
    <div class="login-box">
        <form class="login-form" action="{{ route('dashboard.login') }}" method="post">
            ...
            <div class="form-group">
                <div class="utility">
                    ...
                    <p class="semibold-text mb-2">
                        <a href="{{ route('password.request') }}" style="color:#3F66B0; " data-toggle="flip">
            ...
            <div class="form-group btn-container">
                <button class="btn btn-primary btn-block" style="background-color:#3F66B0; border-color:#3F66B0;" type="submit">

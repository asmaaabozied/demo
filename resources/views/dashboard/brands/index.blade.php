...
@section('content')
    ...
    <div class="col-sm-offset-3 col-lg-8 col-lg-offset-2 main innerPage">
        ...
        <div class="contentDiv">
            <h1 class="page-header">@lang('brands.plural')</h1>

            <div class="col-md-12">
                <div class="topLinks">
                    <a  class="active"> @lang('brands.plural')</a>
            ...
            : activate to sort column descending" style="width: 51px;">
                                        ...
                                        @foreach($brands as $product)
                                            ...
                                            <tr class="odd" id="ff{{$product->id}}">
                                                ...
                                                <td>
                                                    <a href="{{ route('dashboard.brands.edit', $product->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('dashboard.brands.destroy', $product->id)}}"
    ...
    <div class="col-lg-2 forFullWid innerPage">
        <ul class="pull-right panel-settings panel-button-tab-right">
            <li class="dropdown delRed btn-primary">
                <a href="{{route('dashboard.brands.create')}}" class="btn "> + </a>
            </li>
        </ul>
        <div class="ppR">
            <ul class="pull-right panel-settings panel-button-tab-right">
    ...
    <script>
        ...
        $('#deleteAll').click(function (e) {
            ...
            $.ajax({
                ...
                'url': "{{route('dashboard.deleteAllbrands')}}",
                type: 'Delete',
                data: {

{{--<x-layout :title="Str::limit($product->name, 50)" :breadcrumbs="['dashboard.attributeproducts.edit', $product]">--}}
{{--    {{ BsForm::resource('attributeproducts')->putModel($product, route('dashboard.attributeproducts.update', $product)) }}--}}
{{--    @component('dashboard::components.box')--}}
{{--        @slot('title', trans('products_attribute.actions.edit'))--}}
...
{{--                    <option value="{{$key}}"  @if($product->producttype_id ==$key) selected @endif>{{$value}}</option>--}}
{{--                @endforeach--}}
{{--            </select>--}}
{{--        </div>--}}

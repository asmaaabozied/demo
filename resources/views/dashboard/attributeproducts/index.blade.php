{{--<x-layout :title="request('in_stock')=='false' ? trans('products.out_of_stock') : trans('products_attribute.plural')" :breadcrumbs="['dashboard.attributeproducts.index']">--}}

{{--    {{ BsForm::resource('attributeproducts')->get(url()->current()) }}--}}
{{--    @component('dashboard::components.box')--}}
{{--        @slot('title', trans('products_attribute.filter'))--}}
...
{{--                @lang('products_attribute.actions.filter')--}}
{{--            </button>--}}
{{--        @endslot--}}
{{--    @endcomponent--}}
{{--    {{ BsForm::close() }}--}}
...
{{--                    <a href="{{ route('dashboard.attributeproducts.create') }}" class="btn btn-outline-success btn-sm">--}}
{{--                        <i class="fas fa fa-fw fa-plus"></i>--}}
{{--                        @lang('products_attribute.actions.create')--}}
{{--                    </a>--}}
...
{{--                <th style="width: 160px">@lang('product_types.plural')</th>--}}
...
{{--            <tr>--}}
{{--                <td>--}}
{{--                    <a href="{{ route('dashboard.attributeproducts.show', $product) }}"--}}
...
{{--                            <a href="{{ route('dashboard.attributeproducts.show', $product->id) }}" class="btn btn-outline-dark btn-sm">--}}
{{--                                <i class="fas fa fa-fw fa-eye"></i>--}}
{{--                            </a>--}}
{{--                                <a href="{{ route('dashboard.attributeproducts.edit', $product->id) }}" class="btn btn-outline-primary btn-sm">--}}
...
@section('content')
    ...
    <div class="col-sm-offset-3 col-lg-8 col-lg-offset-2 main innerPage">
        ...
        <div class="contentDiv">
            ...
            <div class="col-md-12">
                <div class="topLinks">
                    <a  class="active"> @lang('products_attribute.plural')</a>
            ...
            : activate to sort column descending" style="width: 51px;">
                                            ...
                                            <th scope="col" class="sorting" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="name: activate to sort column ascending"
                                                style="width: 78px;">@lang('products.plural')
                                            </th>
                                            <th scope="col" class="sorting" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="name: activate to sort column ascending"
                                                style="width: 78px;">@lang('site.size')
                                            </th>
                                            <th scope="col" class="sorting" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="name: activate to sort column ascending"
                                                style="width: 78px;">@lang('site.price')
                                            </th>
                                        ...
                                        @foreach($products as $product)
                                            ...
                                            <tr class="odd" id="ff{{$product->id}}">
                                                ...
                                                <td> <a href="{{ route('dashboard.attributeproducts.show', $product->id)}}">{{ $product->name }} </a> </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('dashboard.attributeproducts.edit', $product->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('dashboard.attributeproducts.destroy', $product->id)}}"
    ...
    <div class="col-lg-2 forFullWid innerPage">
        <ul class="pull-right panel-settings panel-button-tab-right">
            <li class="dropdown delRed btn-primary">
                <a href="{{route('dashboard.attributeproducts.create')}}" class="btn "> + </a>
            </li>
        </ul>
        <div class="ppR">
            <ul class="pull-right panel-settings panel-button-tab-right">
        ...
        <div class="topSell">
            <h6>@lang('products_attribute.plural')</h6>
    ...
    <script>
        ...
        $('#deleteAll').click(function (e) {
            ...
            $.ajax({
                ...
                'url': "{{route('dashboard.deleteattributeproducts')}}",
                type: 'Delete',
                data: {

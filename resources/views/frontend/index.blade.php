      ...
      <div class="row">
         <div class="col-lg-7 col-md-12 rWbg forMobOnly" style="height: 754px;">
            <form action="" class="perfSerch">
               <input type="text" placeholder="" id="myInput2" onkeyup="getMySearch4()">

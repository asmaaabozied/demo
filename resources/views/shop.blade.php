        ...
        <div class="container">
            <div class="row">
                ...
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang('front.our_products')</li>
                    </ol>
                </nav>
                </div>
                <div class="col-lg-7 col-md-12">
                    <h3>@lang('front.our_products')</h3>
                </div>
            </div>
    </section>
    <section class="ourP">
                  ...
                  <div class="dropdown col-12">
                      ...
                      <div class="filter-nav dropdown-menu">
                          ...
                          @foreach($categories as $category)
                              <button class="btn filter-button dropdown-item" data-filter="{{ $category->id }}">{{ $category->name }}</button>
                          @endforeach
                      </div>
                  </div>
                  ...
                  <div class="filter-gallery col-12">
                    <div class="row">
                      ...
                      @foreach ($products as $product)
                          @include('layouts.yo3an_wagef.partials.product-item')
                      @endforeach
...
{{--                       <div class="col-md-3 my-1 animate__zoomIn">
                        <div class="" data-category="nature">
                          <div class="item-content">
                              <div class="PItem">
                                  <img src="{{ asset('front/yo3an_wagef') }}/img/sp1.png" alt="">
                                  <h4>cake</h4>
                      ...
                      <div class="col-md-3 my-1 animate__zoomIn">
                        <div class="" data-category="architecture">
                          <div class="item-content">
                              <div class="PItem">
                                  <img src="{{ asset('front/yo3an_wagef') }}/img/sp2.png" alt="">
                                  <h4>cake</h4>
                                  <h6> <span>KWD 200</span> KWD 100</h6>
                                </div>
                          </div>
                      ...
                      <div class="col-md-3 my-1">
                        <div class="" data-category="nature">
                          <div class="item-content">
                            <div class="PItem">
                            <img src="{{ asset('front/yo3an_wagef') }}/img/chocoR2.png" alt="">
                            <h4>cake</h4>
                            <h6> <span>KWD 200</span> KWD 100</h6>
                          </div>
                          </div>
